...
1. Learning as much about AI as possible before it takes over.
...
1. [Orcaflow](https://orcaflow.dev), open-source project. For the power users, the grinders, the I-gotta-work-rn kind of people. My contribution to the engineering community :)
...
1. [Orcaflow aka Remote Coder](https://orcaflow.dev) - Slack-first daemon that interacts with local coding agents via Slack threads and makes PRs to GitHub remote repository.
...
## My current mindspace in a gif:
<p align="center">
  <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExeDlzdDlvbmN5cHpmZmZpam9vZ3VoM3F0MThqZmQ1ZndwbzJsendpaCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/kspVl6FzbdblOMKRmM/giphy.gif" alt="This is fine dog" width="300">
</p>
